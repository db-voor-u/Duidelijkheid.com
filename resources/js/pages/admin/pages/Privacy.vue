...
const form = useForm({
    title: props.policy?.title || 'Privacybeleid',
...
const submit = () => {
    form.put(routes.admin.privacyContent, {
        preserveScroll: true,
        onSuccess: () => {
            errorBar.value = ''
...
<template>
    <Head title="Bewerk Privacybeleid" />

    <AdminAppLayout :breadcrumbs="[
        { title: 'Dashboard', href: routes.admin.dashboard },
        { title: 'Privacybeleid', href: routes.admin.privacyContent },
    ]">
        <div class="mx-auto max-w-7xl space-y-6 p-6">
            <Card>
                <CardHeader>
                    <CardTitle>Privacybeleid</CardTitle>
                    <CardDescription>Pas hier de inhoud van het privacybeleid aan.</CardDescription>
                </CardHeader>
                <CardContent class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <Input id="title" v-model="form.title" placeholder="Bijv. Privacybeleid" />
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="overflow-hidden rounded-md border focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2">
                            <RichTextEditor
                                ...
                                placeholder="Schrijf hier het privacybeleid..."
                                height="400px"
                            />
                        </div>
